...
int main() {
	...
	if (strcmp("home", modekey3) == 0) {
	  modekey = 0x24;
	}
	if (strcmp("delete", modekey3) == 0) {
	  modekey = 0x2E;
	}
	if (strcmp("insert", modekey3) == 0) {
	  modekey = 0x2D;
	}
	if (strcmp("page_up", modekey3) == 0) {
	  modekey = 0x21;
	}
	if (strcmp("page_down", modekey3) == 0) {
	  modekey = 0x22;
	}
	if (strcmp("end", modekey3) == 0) {
	  modekey = 0x23;
	}
	if (modekey == 69696969) {
